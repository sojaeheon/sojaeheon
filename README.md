<h1 align="center">안녕하세요, 소재헌입니다 👋</h1>

<p align="center">
  <b>Data Engineering · Infrastructure · Backend</b>
</p>

<p align="center">
  안정적인 데이터 흐름을 설계하고, 데이터를 서비스 가치로 연결하는 개발자를 지향합니다.<br/>
  데이터 수집, 처리, 분석, 검색, 실시간 스트리밍, AI 활용까지 이어지는 흐름에 관심이 있습니다.
</p>
...
* 데이터가 사용자에게 실제 가치로 전달되는 서비스 흐름에 관심이 있습니다.
* 백엔드, 데이터 파이프라인, 인프라가 함께 동작하는 구조를 고민합니다.
* Kafka, Flink, Airflow, Elasticsearch 기반 데이터 처리·검색 흐름을 경험했습니다.
* Docker, AWS EC2/ECR, Nginx, Jenkins, Kubernetes 기반 실행 환경과 배포 흐름을 경험했습니다.
* 데이터 분석과 AI 기능을 서비스에 연결하는 프로젝트를 진행해왔습니다.
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=sojaeheon&show_icons=true&hide_border=true" height="160"/>
  <img src="https://streak-stats.demolab.com?user=sojaeheon&hide_border=true" height="160"/>
</p>
